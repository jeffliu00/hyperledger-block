...
describe('MyAssetContract-block@0.0.2' , () => {
    ...
    describe('myAssetExists', () => {
        it('should evaluate myAssetExists transaction', async () => {
            ...
            const response: Buffer = await SmartContractUtil.evaluateTransaction('MyAssetContract', 'myAssetExists', args, gateway);
    ...
    describe('createMyAsset', () => {
        it('should submit createMyAsset transaction', async () => {
            ...
            const response: Buffer = await SmartContractUtil.submitTransaction('MyAssetContract', 'createMyAsset', args, gateway);
    ...
    describe('readMyAsset', () => {
        it('should evaluate readMyAsset transaction', async () => {
            ...
            const myAssetId: string = 'EXAMPLE';
            const args: string[] = [ myAssetId];
            const response: Buffer = await SmartContractUtil.evaluateTransaction('MyAssetContract', 'readMyAsset', args, gateway);
    ...
    describe('updateMyAsset', () => {
        it('should submit updateMyAsset transaction', async () => {
            ...
            const response: Buffer = await SmartContractUtil.submitTransaction('MyAssetContract', 'updateMyAsset', args, gateway);
    ...
    describe('deleteMyAsset', () => {
        it('should submit deleteMyAsset transaction', async () => {
            ...
            const myAssetId: string = 'EXAMPLE';
            const args: string[] = [ myAssetId];
            const response: Buffer = await SmartContractUtil.submitTransaction('MyAssetContract', 'deleteMyAsset', args, gateway);
    ...
    describe('queryAllAssets', () => {
        it('should evaluate queryAllAssets transaction', async () => {
            ...
            const args: string[] = [];
            const response: Buffer = await SmartContractUtil.evaluateTransaction('MyAssetContract', 'queryAllAssets', args, gateway);
